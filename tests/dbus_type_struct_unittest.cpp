...
void TestUnmarshallFromMessageIStream(unsigned byteOrder, const std::string& stream, uint32_t v1, uint32_t v2)
{
...
void TestUnmarshallMessageIStream(unsigned byteOrder, uint32_t v1, uint32_t v2)
{
    std::string data;
