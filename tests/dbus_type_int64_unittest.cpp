...
TEST_CASE("Unmarshall int64 little endian from MessageIStream")
{
    ...
    TestUnmarshallFromMessageIStream<int64_t, Type::Int64>(__LITTLE_ENDIAN, value, dbusType);
}
...
TEST_CASE("Unmarshall int64 big endian from MessageIStream")
{
    Type::Int64 dbusType;
    const int64_t value = 98987654549204454LL;
    TestUnmarshallFromMessageIStream<int64_t, Type::Int64>(__BIG_ENDIAN, value, dbusType);
}
...
TEST_CASE("Marshall and unmarshall int 64")
{
    ...
    TestUnmarshallFromMessageIStream<int64_t, Type::Int64>(value, dbusType, istream);
}
