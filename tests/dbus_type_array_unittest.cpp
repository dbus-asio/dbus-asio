...
namespace test {
    ...
    TEST_CASE(
        "Unmarshall an array of structs from MessageIStream - little endian")
    {
    ...
    TEST_CASE("Array round trip")
    {
        ...
        SECTION("Byte") { input.add(DBus::Type::Byte(42)); }
        ...
        SECTION("ObjectPath") { input.add(DBus::Type::ObjectPath("/object/path")); }
