...
namespace test {
    ...
    {
        Type::Boolean True;
        TestUnmarshallFromMessageIStream<uint32_t, Type::Boolean>(__LITTLE_ENDIAN, 1,
            True);

        Type::Boolean False;
        TestUnmarshallFromMessageIStream<uint32_t, Type::Boolean>(__LITTLE_ENDIAN, 0,
            False);
    }
    ...
    {
        Type::Boolean True;
        TestUnmarshallFromMessageIStream<uint32_t, Type::Boolean>(__BIG_ENDIAN, 1,
            True);

        Type::Boolean False;
        TestUnmarshallFromMessageIStream<uint32_t, Type::Boolean>(__BIG_ENDIAN, 0,
            False);
    }
