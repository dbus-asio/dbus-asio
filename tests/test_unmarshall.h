...
void TestUnmarshallFromMessageIStream(T value, D &dbusType, MessageIStream& istream)
{
...
template<class T, class D>
void TestUnmarshallFromMessageIStream(unsigned byteOrder, T value, D &dbusType)
{
